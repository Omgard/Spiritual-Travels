package com.omgard.ritecraft.util.enums;
...
public enum ModArmorMaterial implements IArmorMaterial {
	...
	WARTHOG(Main.MOD_ID + ":warthog", 5, new int[] { 2, 5, 6, 2 }, 18, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F,
			() -> {
				return Ingredient.fromItems(ModItems.WARTHOG_TUSK.get());
			});
