...
public class ElkModel extends EntityModel<Entity> {
	...
	public ElkModel() {
		...
		neck.setRotationPoint(0.0F, 3.0F, -11.0F);
		neck.setTextureOffset(104, 41).addBox(-2.0F, -4.0F, -3.0F, 4.0F, 9.0F, 8.0F, 0.0F, false);
		...
		child_back_left_leg.setRotationPoint(3.0F, 13.0F, 8.0F);
		

		child_back_left_leg_sub_0 = new ModelRenderer(this);
		child_back_left_leg_sub_0.setRotationPoint(-3.0F, 11.0F, -8.0F);
		...
		setRotationAngle(child_back_right_leg, 0.0436F, 0.0F, 0.0F);
		...
		child_front_right_leg.setTextureOffset(27, 9).addBox(-2.0F, -5.5F, -2.0F, 4.0F, 22.0F, 4.0F, 0.0F, false);
		...
		right_gevir.setRotationPoint(4.125F, -6.0F, -9.25F);
		right_gevir.setTextureOffset(104, 24).addBox(-3.125F, 2.0F, -2.75F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		right_gevir.setTextureOffset(110, 19).addBox(-1.125F, 1.0F, -0.75F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		right_gevir.setTextureOffset(112, 12).addBox(-0.125F, -2.0F, -0.75F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		right_gevir.setTextureOffset(112, 3).addBox(0.875F, -5.0F, -1.75F, 1.0F, 3.0F, 5.0F, 0.0F, false);

		right_gevir2 = new ModelRenderer(this);
		right_gevir2.setRotationPoint(-4.125F, -6.0F, -9.25F);
		right_gevir2.setTextureOffset(88, 24).addBox(0.125F, 2.0F, -2.75F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		right_gevir2.setTextureOffset(87, 19).addBox(-0.875F, 1.0F, -0.75F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		right_gevir2.setTextureOffset(84, 12).addBox(-0.875F, -2.0F, -0.75F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		right_gevir2.setTextureOffset(75, 3).addBox(-1.875F, -5.0F, -1.75F, 1.0F, 3.0F, 5.0F, 0.0F, false);
	}
